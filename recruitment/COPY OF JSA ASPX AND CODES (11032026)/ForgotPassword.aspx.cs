    ...
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        protected void Sendmail()
        {
            ...
            if (!string.IsNullOrEmpty(password))
            {
                ...
                mm.Body = string.Format("<br /> <h2> CSIR MADRAS COMPLEX </h2>, <h3> ONLINE APPLICATION 2025 - NOTIFICATION NO: MC-01/2025 </h3> <h4> Hi {0},<br /><br /> Your password is <strong> {1} </strong>.</h4><br /><br />Thank You. <br/> (Warning: Don't reply anything to this email)", username, pwdlbl.Text);
                mm.IsBodyHtml = true;
