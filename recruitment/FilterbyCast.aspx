<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="FilterbyCast.aspx.cs" Inherits="recruitment.FilterbyCast" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link btn-info active" href="FilterbyCast.aspx">Filter By Cast </a>
      </li>
         <li class="nav-item">
        <a class="nav-link" href="ApplicationManagement.aspx">Application Management</a>
                    ...
                    <div class="card-header">
   <center> <h5>Filter By Cast Category</h5>  </center>
  </div>
                    <div class="card-body">
            ...
            &nbsp; &nbsp; &nbsp; <asp:Label ID="Label1" runat="server" Text="Cast Category:"></asp:Label>
                           &nbsp; &nbsp; &nbsp;  <asp:DropDownList ID="CastListDrop" runat="server"  AutoPostBack="True" Height="27px" Width="257px" OnSelectedIndexChanged="CastListDrop_SelectedIndexChanged" >
